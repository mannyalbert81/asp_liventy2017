...
{
    public partial class contGraficasActualizacionMatrizJuicios : System.Web.UI.Page
    {
        ...
        protected void CrystalReportViewer1_Init(object sender, EventArgs e)
        {
            ...
            var dsGraficas = new Datas.dtGraficasActualizacion();
            ...
            string columnas = "COUNT(id_juicios) as total, TO_CHAR(juicios.modificado,'YYYY-MM') as modificado";
            ...
            string grupo = "TO_CHAR(juicios.modificado,'YYYY-MM')";
            string id = "TO_CHAR(juicios.modificado,'YYYY-MM')";
            ...
            string cadena = Server.MapPath("~/Reporte/rptGraficasActualizacion.rpt");
