...
namespace Datos
{
    class MetodosDatos
    {
        ...
        public static string cadenaConexion = @"Server=192.168.10.10;Port=5432;User Id=postgres;Password=.Romina.2012;Database=coactiva_liventy;Preload Reader = true;";
