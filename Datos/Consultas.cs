...
//maycol
        ...
        public DataTable Select(string columnas, string tabla, string where, string grupo, string order)
        {
            where = where.Replace("''", "null");
            string comando = "SELECT " + columnas + " FROM " + tabla + " WHERE " + where + " GROUP BY " + grupo + " ORDER BY " + order;
            return MetodosDatos.EjecutarConsula(comando);
        }
